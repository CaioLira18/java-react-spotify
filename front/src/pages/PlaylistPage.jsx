...
const PlaylistPage = () => {
  ...
  const addMusicToFavorites = async () => {
    ...
    try {
      const response = await fetch(`${API_URL}/users/${userID}/favorites/music/${selectedSong.id}`, {
        method: 'POST',
  ...
  const findAlbumForSong = (songId) => {
    const album = albums.find(album => album.musicsNames?.some(music => music.id === songId))
  ...
  async function addMusicToPlaylist(songId) {
    ...
    try {
      const response = await fetch(`${API_URL}/playlists/${playlistData.id}/music/${songId}`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' }
      });
      if (response.ok) {
        ...
        <div className="playlist-header-section">
          ...
          <div className="playlist-header-info">
            ...
            <div className="playlist-meta-info">
              <img src={userPhoto} alt="User" className="playlist-artist-avatar" />
